...
public class WebConfigurer implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(adminInterceptor).addPathPatterns("/admin","/user_edit","/user_info","/message_create","/deleteGuestbook","/updateGuestbook").excludePathPatterns("/test","/test2");
